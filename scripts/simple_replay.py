...
@click.command()
@click.option("--bag_path", default=def_path, help="Path to bag file", type=click.Path(exists=True))
...
def replay_motions(bag_path, percent_to_replay, ecm_pos, record_im, output_p: Path):
